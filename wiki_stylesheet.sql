...
CREATE TABLE `stylesheet` (
  ...
  `StyleSheet` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`ID`)
...
INSERT INTO `stylesheet` VALUES (3,'Classic','classic'),(4,'Cyclops','cyclops'),(5,'Feffoid','feffoid'),(6,'SGA','sga'),(7,'Typhon 2','typhon2'),(8,'Wastelanders','wastelanders'),(9,'Rocktropia','rocktropia1'),(10,'Arkadia','arkadia'),(11,'Old Entropedia','old');
